...
from program_top.components import zmq_io_gateway
from program_top.components import tcp_gateway
...
class standalone_working_class(component_base):
	...
	def __port_and_loop_initilisation(self):
		...
		self._io_gateway=tcp_gateway(port_for_listening, self.request_in, self)
		pass
